...
const TeamCard = ({cardinfo}) => {
   ...
   const styles = {
      ...
      descbox: `flex flex-col justify-end z-1 bg-[#f1f1f1] p-2 max-w-[280px] min-w-[120px] max-h-[94px] md:max-h-[120px] md:h-[120px] md:h-[100px] mx-[10px] pt-[30px] md:pt-[40px] mx-0 md:mx-auto pb-[10px] rounded-r-full  `,
