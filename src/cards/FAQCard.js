...
const styles = {
   ...
   question: ` cursor-pointer bg-[#ffffff] flex flex-row justify-between mx-[20px] uppercase text-[15px] font-[Kollektif]`,
   icon: `mx-3 cursor-pointer `,
   hidden: `hidden h-[0px]`,
   answerdiv: `p-3 py-3 bg-[#f5faf8] mx-4 text-[13px] text-[#79818d] md:w-[400px] uppercase font-[Kollektif]`,
}
