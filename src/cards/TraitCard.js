...
const styles = {
   container: `bg-[#f1f1f1] shadow-lg flex flex-col md:p-3 container  mx-auto  md:max-w-[800px]   md:w-[700px] md:flex-row flex-wrap justify-center w-[320px] max-w-[320px] `,
